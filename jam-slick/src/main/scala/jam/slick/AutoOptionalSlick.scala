...
trait AutoOptionalSlick { self: Slick =>
  ...
  @inline implicit def deriveGROHCons1[H, T <: HList](implicit ch: Lazy[GetResultOption[H]],
                                                      ct: Lazy[GetResultOption[T]]): GetResultOption[H :: T] =
    GetResultOptionTypeClass.product(ch.value, ct.value)
  @inline implicit def deriveGROHCons2[H, T <: HList](implicit ch: Lazy[GetResultOption[H]],
                                                      ct: Lazy[GetResultOption[T]]): GetResultOption[Option[H] :: T] =
  ...
  @inline implicit def deriveReadOptionHCons1[H, T <: HList](implicit ch: Lazy[ReadOption[H]],
                                                             ct: Lazy[ReadOption[T]]): ReadOption[H :: T] =
    ReadOptionTypeClass.product(ch.value, ct.value)
  @inline implicit def deriveReadOptionHCons2[H, T <: HList](implicit ch: Lazy[ReadOption[H]],
                                                             ct: Lazy[ReadOption[T]]): ReadOption[Option[H] :: T] =
