...
class SignatureComposite(atName: String, byName: String) extends Composite[Signature] {
  ...
  val properties: Properties[Signature] = (at :: by :: HNil).properties[Signature]
}
...
class TraceComposite extends Composite[Trace] {
  ...
  val properties: Properties[Trace] = (created.widen :: updated.widen :: HNil).properties[Trace]
}
...
class CompanyEntity extends Entity[Company] {
  ...
  object data extends Composite[CompanyData] {
    ...
    val properties: Properties[CompanyData] = (name :: email :: companyType :: HNil).properties[CompanyData]
  }
  object trace extends TraceComposite
  val properties: Properties[Company] = (uuid :: data.widen :: trace.widen :: HNil).properties[Company]
}
...
object CityEntity extends Entity[City] {
  ...
  val properties: Properties[City] =
    (id :: name :: countryCode :: district :: population :: HNil).properties[City]
}
...
object CountryEntity extends Entity[Country] {
  ...
  val properties: Properties[Country] =
    (code :: name :: continent :: region :: surfaceArea :: independenceYear :: population :: lifeExpectancy :: HNil).properties[Country]
}
...
object CountryLanguageEntity extends Entity[CountryLanguage] {
  ...
  val properties: Properties[CountryLanguage] =
    (countryCode :: language :: isOfficial :: percentage :: HNil).properties[CountryLanguage]
