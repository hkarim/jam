...
trait ModelSyntax {
  ...
  implicit class ExpressionOps[A](l: Expression[A]) {
    ...
    def notIn(first: Expression[A],
              rest: Expression[A]*): Expression[Boolean] =
      InNode(l, first +: rest, negate = true)

    def +(r: Expression[A])(implicit ev: Infix[ArithmeticOperator.Plus.type,
                                               Expression,
                                               Expression,
                                               A,
                                               A]): Expression[A] =
      ev(ArithmeticOperator.Plus, l, r)
    def -(r: Expression[A])(implicit ev: Infix[ArithmeticOperator.Minus.type,
                                               Expression,
                                               Expression,
                                               A,
                                               A]): Expression[A] =
    ...
    def *(r: Expression[A])(
        implicit ev: Infix[ArithmeticOperator.Multiply.type,
                           Expression,
                           Expression,
                           A,
                           A]): Expression[A] =
      ev(ArithmeticOperator.Multiply, l, r)
    def /(r: Expression[A])(implicit ev: Infix[ArithmeticOperator.Divide.type,
                                               Expression,
                                               Expression,
                                               A,
                                               A]): Expression[A] =
    ...
    def ===(r: Expression[A])(
        implicit ev: Infix[EqOperator.Eq.type,
                           Expression,
                           Expression,
                           A,
    ...
    def =!=(r: Expression[A])(
        implicit ev: Infix[EqOperator.Ne.type,
                           Expression,
                           Expression,
                           A,
                           Boolean]): Expression[Boolean] =
    ...
    def >(r: Expression[A])(implicit ev: Infix[PartialOrderOperator.Gt.type,
                                               Expression,
                                               Expression,
                                               A,
                                               Boolean]): Expression[Boolean] =
    ...
    def >=(r: Expression[A])(
        implicit ev: Infix[PartialOrderOperator.Ge.type,
                           Expression,
                           Expression,
                           A,
                           Boolean]): Expression[Boolean] =
      ev(PartialOrderOperator.Ge, l, r)
    def <(r: Expression[A])(implicit ev: Infix[PartialOrderOperator.Lt.type,
                                               Expression,
                                               Expression,
                                               A,
                                               Boolean]): Expression[Boolean] =
    ...
    def <=(r: Expression[A])(
        implicit ev: Infix[PartialOrderOperator.Le.type,
                           Expression,
                           Expression,
                           A,
                           Boolean]): Expression[Boolean] =
  ...
  implicit class BooleanOps(l: Expression[Boolean]) {
    def and(r: Expression[Boolean])(
        implicit ev: Infix[LogicOperator.And.type,
                           Expression,
                           Expression,
                           Boolean,
                           Boolean]): Expression[Boolean] =
    ...
    def or(r: Expression[Boolean])(
        implicit ev: Infix[LogicOperator.Or.type,
                           Expression,
                           Expression,
                           Boolean,
                           Boolean]): Expression[Boolean] =
  ...
  implicit class PropertiesOps[In <: HList, Out <: HList, LOut <: HList,
  ZOut <: HList](out: Out) {
    def properties[A](
        implicit g: Generic.Aux[A, In],
  ...
  implicit def entity[E, H](
      implicit g: Generic.Aux[E, H]): TInsertInto[Entity, E] =
  ...
  implicit class PropertyAliasOps[A](pa: PropertyAliasNode[A])
      extends PropertyLikeSyntax[A] {
